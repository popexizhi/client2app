...
class jenkins_c():
    ...
    def build_job(self, tc_id, commit_lists ,branch ="refs/heads/master" , job_name = job_list[0]):
        """
        ...
        self.jc.build_job(job_name, {"file_lists": tc_id, "commit_lists": commit_lists, "gitbranch": branch})
